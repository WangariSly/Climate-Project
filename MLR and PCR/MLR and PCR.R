...
xlim <- ran
ylim <- ran
plot(actual, pred, xlab = "Actual", ylab = "Predicted", main = "potato yield", xlim = xlim, ylim = ylim)
...
#df4[, 2:ncol(df4)] <- apply(df4[, 2:ncol(df4)], 2, function(x) (x - mean(x))/mean(x))*100
names(df4)#features
attach(df4)
df4 <- df4[,-1]#dropping the years column
head(df4)#view first 6 rows
dim(df4)#dimension of our dataset
df4[, 2:ncol(df4)] <- scale(df4[, 2:ncol(df4)])
...
xlim <- ran
ylim <- ran
plot(actual, pred, xlab = "Actual", ylab = "Predicted", main = "orange yield", xlim = xlim, ylim = ylim)
...
r2_mlr <- cor(mlr_pred, test$Orange.yield)^2
r2_mlr
mse_mlr <- mean((mlr_pred - test$Orange.yield)^2)
mse_mlr
# Calculate correlation coefficient between predicted and actual values
...
# corr_coef
#############################################################################################
df7<-read.csv("data4 Tomato.csv",sep = ',')
#df7[, 2:ncol(df7)] <- apply(df7[, 2:ncol(df7)], 2, function(x) (x - mean(x))/mean(x))*100
names(df7)#features
attach(df7)
df7 <- df7[,-1]#dropping the years column
head(df7)#view first 6 rows
dim(df7)#dimension of our dataset
df7[, 2:ncol(df7)] <- scale(df7[, 2:ncol(df7)])
set.seed(180)
#partitioning the data 70% training 30% testing
df8<-sort(sample(nrow(df7), nrow(df7)*0.7, replace = F))
train <- df7[df8,]
test <- df7[-df8,]
dim(train)
dim(test)
...
xlim <- ran
ylim <- ran
plot(actual, pred, xlab = "Actual", ylab = "Predicted", main = "tomato yield", xlim = xlim, ylim = ylim)
...
# Calculate performance metrics for MLR model
rmse(actual = test$Tomato.yield,predicted = as.numeric(mlr_pred))#the lower the error the better
r2_mlr <- cor(mlr_pred, test$Tomato.yield)^2
r2_mlr
mse_mlr <- mean((mlr_pred - test$Tomato.yield)^2)
mse_mlr
# Calculate correlation coefficient between predicted and actual values
...
# corr_coef
#############################################################################################
df9<-read.csv("data5 Wheat.csv",sep = ',')
#df9[, 2:ncol(df9)] <- apply(df9[, 2:ncol(df9)], 2, function(x) (x - mean(x))/mean(x))*100
names(df9)#features
attach(df9)
df9 <- df9[,-1]#dropping the years column
head(df9)#view first 6 rows
dim(df9)#dimension of our dataset
df9[, 2:ncol(df9)] <- scale(df9[, 2:ncol(df9)])
set.seed(220)
#partioning the data 70% training 30% testing
df10<-sort(sample(nrow(df9), nrow(df9)*0.7, replace = F))
train <- df9[df10,]
test <- df9[-df10,]
dim(train)
dim(test)
...
xlim <- ran
ylim <- ran
plot(actual, pred, xlab = "Actual", ylab = "Predicted", main = "wheat yield", xlim = xlim, ylim = ylim)
...
pcr_pred<-predict(pcr_model,test,ncomp = 1)#we are using 4 PCs
pcr_pred
...
abline(a = intercept_actual, b = slope_actual, col = 'red')
# Calculate performance metrics for MLR model
rmse(actual = test$Maize.yield,predicted = as.numeric(pcr_pred))#the lower the error the better
r2_mlr <- cor(pcr_pred, test$Maize.yield)^2
r2_mlr
mse_mlr <- mean((pcr_pred - test$Maize.yield)^2)
mse_mlr
# Calculate correlation coefficient between predicted and actual values
...
#predicting based on the principal component regression
pcr_pred<-predict(pcr_model,test,ncomp = 7)#we are using 4 PCs
pcr_pred
...
# Calculate performance metrics for MLR model
rmse(actual = test$Potato.yield,predicted = as.numeric(pcr_pred))#the lower the error the better
r2_mlr <- cor(pcr_pred, test$Potato.yield)^2
r2_mlr
mse_mlr <- mean((pcr_pred - test$Potato.yield)^2)
mse_mlr
# Calculate correlation coefficient between predicted and actual values
corr_coef <- cor(pcr_pred, test$Potato.yield)
corr_coef
...
# Calculate performance metrics for MLR model
rmse(actual = test$Orange.yield,predicted = as.numeric(pcr_pred))#the lower the error the better
r2_mlr <- cor(pcr_pred, test$Orange.yield)^2
r2_mlr
mse_mlr <- mean((pcr_pred - test$Orange.yield)^2)
mse_mlr
# Calculate correlation coefficient between predicted and actual values
corr_coef <- cor(pcr_pred, test$Orange.yield)
corr_coef
...
# Calculate performance metrics for MLR model
rmse(actual = test$Tomato.yield,predicted = as.numeric(pcr_pred))#the lower the error the better
r2_mlr <- cor(pcr_pred, test$Tomato.yield)^2
r2_mlr
mse_mlr <- mean((pcr_pred - test$Tomato.yield)^2)
mse_mlr
# Calculate correlation coefficient between predicted and actual values
corr_coef <- cor(pcr_pred, test$Tomato.yield)
corr_coef
# #calculate root mean squared error
...
# Calculate performance metrics for MLR model
rmse(actual = test$Wheat.yield,predicted = as.numeric(pcr_pred))#the lower the error the better
r2_mlr <- cor(pcr_pred, test$Wheat.yield)^2
r2_mlr
mse_mlr <- mean((pcr_pred - test$Wheat.yield)^2)
mse_mlr
# Calculate correlation coefficient between predicted and actual values
